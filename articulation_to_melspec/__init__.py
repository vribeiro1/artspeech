...
ARTICULATORS_EMBEDDING_WEIGHTS_FILEPATH = os.path.join(ASSETS_DIR, "articulators_embed.pt")
...
if not os.path.isfile(GLOW_TTS_WEIGHTS_FILEPATH):
    logging.warning("Glow-TTS weights file not available.")

if not os.path.isfile(ARTICULATORS_EMBEDDING_WEIGHTS_FILEPATH):
    logging.warning("ArticulatorsEmbedding weights file not available.")
